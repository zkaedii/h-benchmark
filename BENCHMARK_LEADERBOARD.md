...
*Last updated: 2025-12-20 01:07:37 UTC*
...
| 8  | `scalability_2q` | 2 | **0.074** | 0.0000 | 0.2500 | `dense` |
| 9  | `scalability_4q` | 4 | **0.074** | 0.0000 | 0.0625 | `dense` |
| 10  | `scalability_2q` | 2 | **0.075** | 0.0000 | 0.2500 | `dense` |
| 11  | `scalability_2q` | 2 | **0.075** | 0.0000 | 0.2500 | `dense` |
| 12  | `scalability_4q` | 4 | **0.075** | 0.0000 | 0.0625 | `dense` |
| 13  | `scalability_4q` | 4 | **0.076** | 0.0000 | 0.0625 | `dense` |
| 14  | `scalability_2q` | 2 | **0.076** | 0.0000 | 0.2500 | `dense` |
| 15  | `scalability_4q` | 4 | **0.076** | 0.0000 | 0.0625 | `dense` |
| 16  | `scalability_2q` | 2 | **0.077** | 0.0000 | 0.2500 | `dense` |
| 17  | `scalability_2q` | 2 | **0.078** | 0.0000 | 0.2500 | `dense` |
| 18  | `scalability_4q` | 4 | **0.081** | 0.0000 | 0.0625 | `dense` |
| 19  | `scalability_2q` | 2 | **0.082** | 0.0000 | 0.2500 | `dense` |
| 20  | `scalability_4q` | 4 | **0.083** | 0.0000 | 0.0625 | `dense` |
