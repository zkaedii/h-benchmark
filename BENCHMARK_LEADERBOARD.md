...
*Last updated: 2025-12-26 01:12:20 UTC*
...
| 9  | `scalability_3q` | 3 | **0.068** | 0.0000 | 0.1250 | `dense` |
| 10  | `scalability_3q` | 3 | **0.069** | 0.0000 | 0.1250 | `dense` |
| 11  | `scalability_3q` | 3 | **0.070** | 0.0000 | 0.1250 | `dense` |
| 12  | `scalability_3q` | 3 | **0.071** | 0.0000 | 0.1250 | `dense` |
| 13  | `scalability_2q` | 2 | **0.071** | 0.0000 | 0.2500 | `dense` |
| 14  | `scalability_3q` | 3 | **0.073** | 0.0000 | 0.1250 | `dense` |
| 15  | `scalability_2q` | 2 | **0.074** | 0.0000 | 0.2500 | `dense` |
| 16  | `scalability_2q` | 2 | **0.074** | 0.0000 | 0.2500 | `dense` |
| 17  | `scalability_4q` | 4 | **0.074** | 0.0000 | 0.0625 | `dense` |
| 18  | `scalability_3q` | 3 | **0.074** | 0.0000 | 0.1250 | `dense` |
