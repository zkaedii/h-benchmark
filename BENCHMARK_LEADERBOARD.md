...
*Last updated: 2025-12-25 01:11:56 UTC*
...
| 12  | `scalability_2q` | 2 | **0.071** | 0.0000 | 0.2500 | `dense` |
| 13  | `scalability_3q` | 3 | **0.073** | 0.0000 | 0.1250 | `dense` |
| 14  | `scalability_2q` | 2 | **0.074** | 0.0000 | 0.2500 | `dense` |
| 15  | `scalability_2q` | 2 | **0.074** | 0.0000 | 0.2500 | `dense` |
| 16  | `scalability_4q` | 4 | **0.074** | 0.0000 | 0.0625 | `dense` |
| 17  | `scalability_3q` | 3 | **0.074** | 0.0000 | 0.1250 | `dense` |
