...
*Last updated: 2026-04-17 01:59:28 UTC*
...
| 2 🥈 | `scalability_3q` | 3 | **0.052** | 0.0000 | 0.1250 | `dense` |
| 3 🥉 | `scalability_3q` | 3 | **0.055** | 0.0000 | 0.1250 | `dense` |
| 4  | `scalability_3q` | 3 | **0.056** | 0.0000 | 0.1250 | `dense` |
| 5  | `scalability_4q` | 4 | **0.058** | 0.0000 | 0.0625 | `dense` |
| 6  | `scalability_3q` | 3 | **0.058** | 0.0000 | 0.1250 | `dense` |
| 7  | `scalability_2q` | 2 | **0.058** | 0.0000 | 0.2500 | `dense` |
| 8  | `scalability_2q` | 2 | **0.058** | 0.0000 | 0.2500 | `dense` |
| 9  | `scalability_2q` | 2 | **0.059** | 0.0000 | 0.2500 | `dense` |
| 10  | `scalability_2q` | 2 | **0.060** | 0.0000 | 0.2500 | `dense` |
| 11  | `scalability_2q` | 2 | **0.060** | 0.0000 | 0.2500 | `dense` |
| 12  | `scalability_2q` | 2 | **0.060** | 0.0000 | 0.2500 | `dense` |
| 13  | `scalability_4q` | 4 | **0.061** | 0.0000 | 0.0625 | `dense` |
| 14  | `scalability_2q` | 2 | **0.061** | 0.0000 | 0.2500 | `dense` |
| 15  | `scalability_3q` | 3 | **0.061** | 0.0000 | 0.1250 | `dense` |
| 16  | `scalability_3q` | 3 | **0.061** | 0.0000 | 0.1250 | `dense` |
| 17  | `scalability_3q` | 3 | **0.061** | 0.0000 | 0.1250 | `dense` |
| 18  | `scalability_3q` | 3 | **0.061** | 0.0000 | 0.1250 | `dense` |
| 19  | `scalability_2q` | 2 | **0.061** | 0.0000 | 0.2500 | `dense` |
| 20  | `scalability_2q` | 2 | **0.061** | 0.0000 | 0.2500 | `dense` |
...
| 2026-04-16 00:27:27 UTC | 3 |
| 2026-04-15 00:27:03 UTC | 3 |
| 2026-04-14 00:26:37 UTC | 3 |
| 2026-04-13 00:24:14 UTC | 3 |
