...
*Last updated: 2026-01-20 00:13:56 UTC*
...
| 9  | `scalability_2q` | 2 | **0.063** | 0.0000 | 0.2500 | `dense` |
| 10  | `scalability_3q` | 3 | **0.064** | 0.0000 | 0.1250 | `dense` |
| 11  | `scalability_4q` | 4 | **0.064** | 0.0000 | 0.0625 | `dense` |
| 12  | `scalability_3q` | 3 | **0.065** | 0.0000 | 0.1250 | `dense` |
| 13  | `scalability_4q` | 4 | **0.065** | 0.0000 | 0.0625 | `dense` |
| 14  | `scalability_3q` | 3 | **0.065** | 0.0000 | 0.1250 | `dense` |
| 15  | `scalability_4q` | 4 | **0.065** | 0.0000 | 0.0625 | `dense` |
| 16  | `scalability_3q` | 3 | **0.066** | 0.0000 | 0.1250 | `dense` |
