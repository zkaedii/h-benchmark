...
*Last updated: 2025-12-21 01:16:31 UTC*
...
| 10  | `scalability_4q` | 4 | **0.074** | 0.0000 | 0.0625 | `dense` |
| 11  | `scalability_2q` | 2 | **0.075** | 0.0000 | 0.2500 | `dense` |
| 12  | `scalability_2q` | 2 | **0.075** | 0.0000 | 0.2500 | `dense` |
| 13  | `scalability_2q` | 2 | **0.075** | 0.0000 | 0.2500 | `dense` |
| 14  | `scalability_4q` | 4 | **0.075** | 0.0000 | 0.0625 | `dense` |
| 15  | `scalability_4q` | 4 | **0.076** | 0.0000 | 0.0625 | `dense` |
| 16  | `scalability_2q` | 2 | **0.076** | 0.0000 | 0.2500 | `dense` |
| 17  | `scalability_4q` | 4 | **0.076** | 0.0000 | 0.0625 | `dense` |
| 18  | `scalability_2q` | 2 | **0.077** | 0.0000 | 0.2500 | `dense` |
| 19  | `scalability_2q` | 2 | **0.078** | 0.0000 | 0.2500 | `dense` |
| 20  | `scalability_4q` | 4 | **0.079** | 0.0000 | 0.0625 | `dense` |
