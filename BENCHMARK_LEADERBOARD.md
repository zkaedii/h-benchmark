...
*Last updated: 2026-01-01 00:15:42 UTC*
...
| 14  | `scalability_3q` | 3 | **0.070** | 0.0000 | 0.1250 | `dense` |
| 15  | `scalability_3q` | 3 | **0.071** | 0.0000 | 0.1250 | `dense` |
| 16  | `scalability_3q` | 3 | **0.071** | 0.0000 | 0.1250 | `dense` |
| 17  | `scalability_2q` | 2 | **0.071** | 0.0000 | 0.2500 | `dense` |
| 18  | `scalability_3q` | 3 | **0.073** | 0.0000 | 0.1250 | `dense` |
| 19  | `scalability_4q` | 4 | **0.073** | 0.0000 | 0.0625 | `dense` |
