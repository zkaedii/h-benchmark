...
*Last updated: 2025-12-28 01:20:26 UTC*
...
| 15  | `scalability_2q` | 2 | **0.071** | 0.0000 | 0.2500 | `dense` |
| 16  | `scalability_3q` | 3 | **0.073** | 0.0000 | 0.1250 | `dense` |
| 17  | `scalability_2q` | 2 | **0.074** | 0.0000 | 0.2500 | `dense` |
| 18  | `scalability_2q` | 2 | **0.074** | 0.0000 | 0.2500 | `dense` |
| 19  | `scalability_4q` | 4 | **0.074** | 0.0000 | 0.0625 | `dense` |
| 20  | `scalability_3q` | 3 | **0.074** | 0.0000 | 0.1250 | `dense` |
