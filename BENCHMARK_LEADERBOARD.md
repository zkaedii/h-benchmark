...
*Last updated: 2026-01-02 00:14:09 UTC*
...
| 15  | `scalability_3q` | 3 | **0.070** | 0.0000 | 0.1250 | `dense` |
| 16  | `scalability_3q` | 3 | **0.071** | 0.0000 | 0.1250 | `dense` |
| 17  | `scalability_3q` | 3 | **0.071** | 0.0000 | 0.1250 | `dense` |
| 18  | `scalability_2q` | 2 | **0.071** | 0.0000 | 0.2500 | `dense` |
| 19  | `scalability_2q` | 2 | **0.073** | 0.0000 | 0.2500 | `dense` |
| 20  | `scalability_3q` | 3 | **0.073** | 0.0000 | 0.1250 | `dense` |
